...
public class PortpolioVo {
	...
	public String toString() {
		...
		/*
		 * @Override public String toString() { return "PortpolioVo [portNum=" + portNum
		 * + ", subject=" + subject + ", portCate=" + portCate + ", portDetailCate=" +
		 * portDetailCate + ", portContents=" + portContents + ", portStartDate=" +
		 * portStartDate + ", portEndDate=" + portEndDate + ", portFile=" + portFile +
		 * ", connectSkill=" + connectSkill + ", rate=" + rate + ", progNum=" + progNum
		 * + "]";
		 */
	}
