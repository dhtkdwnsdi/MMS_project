...
public class PortpolioRegisterAction implements Action {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/*
		 * //parameter가져오기 
		 * String progNum = request.getParameter("progNum"); String
		 * subject = request.getParameter("subject"); String organization =
		 * request.getParameter("organization"); String portCate =
		 * request.getParameter("portCate"); String portDetailCate =
		 * request.getParameter("portDetailCate"); String portContents =
		 * request.getParameter("portContents"); String portStartDate =
		 * request.getParameter("portStartDate"); String portEndDate =
		 * request.getParameter("portEndDate"); String rate =
		 * request.getParameter("rate"); String portFile =
		 * request.getParameter("portFile"); String plNum =
		 * request.getParameter("plNum");
		 * 
		 * PortpolioVO portVo = new PortpolioVO(); PortpolioDAO portDao =
		 * PortpolioDAO.getInstance();
		 * 
		 * portVo.setProgNum(progNum); portVo.setSubject(subject);
		 * portVo.setOrganization(organization); portVo.setPortCate(portCate);
		 * portVo.setPortDetailCate(portDetailCate);
		 * portVo.setPortStartDate(portStartDate); portVo.setPortContents(portContents);
		 * portVo.setPortEndDate(portEndDate); portVo.setRate(rate);
		 * portVo.setPortFile(portFile); portVo.setPlNum(plNum);
		 * 
