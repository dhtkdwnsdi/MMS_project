							...
							<div class="kt-portlet kt-portlet--mobile">
								<div class="kt-portlet__head kt-portlet__head--lg">
									<div class="kt-portlet__head-label">
										...
										<form action="proj?command=projDelete" method="post">
											<!--begin::Section-->
													...
													<table class="table table-bordered">
														<thead>
															<tr>
																...
																<th><b>프로젝트 명</b></th>
																<th><b>카테고리</b></th>
																<th><b>프로젝트 모집 마감일</b></th>
																<th><b>프로젝트 시작 예정일</b></th>
																<th><b>프로젝트 종료 예정일</b></th>
																<th><b>담당자</b></th>
															</tr>
														</thead>
														...
														<tbody>
															<tr>
																...
																<td>${ProjectVO.projName}</td>
																<td>${ProjectVO.projCate}  >>>  ${ProjectVO.projDetailCate}</td>
																<td>${ProjectVO.deadline}</td>
																<td>${ProjectVO.startDuedate}</td>
																<td>${ProjectVO.endDuedate}</td>
																<td>${ProjectVO.progName}</td>
															</tr>
														</tbody>
														</c:forEach>
													</table>
