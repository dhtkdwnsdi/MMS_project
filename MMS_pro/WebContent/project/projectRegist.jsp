			...
			<div class="col-lg-12">
				...
				<div
					...
					<div class="kt-portlet__body">
						<form class="kt-form" id="kt_form" role="form" 
						method="post" action="proj?command=projRegister">
							<div class="row">
								<div class="col-xl-2"></div>
								<div class="col-xl-8">
									<div class="kt-section kt-section--first">
										<div class="kt-section__body">
											<h3 class="kt-section__title kt-section__title-lg">프로젝트 등록</h3>
											
											<div class="form-group row">
												<label class="col-3 col-form-label">프로젝트 명</label>
												<div class="col-9">
													<input class="form-control" type="text" name='projName'>
												</div>
											</div>
											...
											<div class="col-lg-4 col-md-9 col-sm-12">
												<select class="form-control kt-selectpicker" name='projCate'>
													<option value="01">개발</option>
													<option value="02">디자인</option>
												</select>
											</div>
											</div>
											...
											<div class="col-lg-4 col-md-9 col-sm-12">
												<select class="form-control kt-selectpicker" name='projDetailCate'>
													<option value="01">웹</option>
													<option value="02">애플리케이션</option>
													<option value="03">워드프레스</option>
													<option value="04">퍼블리싱</option>
													<option value="05">일반 소프트웨어</option>
													<option value="06">커머스, 쇼핑몰</option>
													<option value="07">게임</option>
													<option value="08">임베디드</option>
											...
											<div class="form-group row">
												...
												<div class="col-lg-9 col-md-9 col-sm-12">
													<div class="input-group date">
														...
														id="kt_datepicker_1_validate" name='endDuedate' />
											...
											<div class="form-group row">
												...
												<div class="col-lg-9 col-md-9 col-sm-12">
													<div class="input-group date">
															...
															id="kt_datepicker_1_validate" name='startDuedate' />
														<div class="input-group-append">
															<span class="input-group-text">
																<i class="la la-calendar-check-o"></i></span>
														</div>
											...
											<div class="form-group row">
												...
												<div class="col-lg-9 col-md-9 col-sm-12">
													<div class="input-group date">
														<input type="text" class="form-control" placeholder="Select date"  
														id="kt_datepicker_1_validate" name='deadline' />
														<div class="input-group-append">
															<span class="input-group-text">
															<i class="la la-calendar-check-o"></i></span>
														</div>
											...
											<div class="col-lg-4 col-md-9 col-sm-12">
												<select class="form-control kt-selectpicker" name='partiFormCode'>
													<option value="01">주관</option>
													<option value="02">컨소시엄</option>
													<option value="03">하도급</option>
											...
											<div class="form-group row">
											<label class="col-form-label col-lg-3 col-sm-12">프레임 워크</label>
											<div class="col-lg-4 col-md-9 col-sm-12">
												<select class="form-control kt-selectpicker" name='fwCode'>
													<option value="01">Mustard</option>
													<option value="02">Ketchup</option>
													<option value="03">Relish</option>
												</select>
											</div>
											</div>
											...
											<div class="col-lg-4 col-md-9 col-sm-12">
												<select class="form-control kt-selectpicker" name='osCode'>
													<option value="01">윈도우</option>
													<option value="02">리눅스</option>
													<option value="03">맥 OS</option>
													<option value="04">유닉스</option>
													<option value="05">안드로이드</option>
												</select>
											</div>
											</div>
											...
											<div class="col-lg-4 col-md-9 col-sm-12">
												<select class="form-control kt-selectpicker" name='dbmsCode'>
													<option value="01">오라클 데이터베이스</option>
													<option value="02">MySQL</option>
													<option value="03">MariaDB</option>
													<option value="04">Microsoft SQL Server</option>
													<option value="05">PostgreSQL</option>
													<option value="06">DB2</option>
													<option value="07">티베로</option>
													<option value="08">Cubrid</option>
													<option value="09">INFORMIX</option>
													<option value="11">ALTIBASE HDB</option>
													<option value="12">SQLite</option>
													<option value="13">XDM/RD</option>
													<option value="14">AIM</option>
													<option value="15">Firebird</option>
													<option value="16">MACHBASE</option>
												</select>
											</div>
											</div>
											...
											<div class="col-lg-4 col-md-9 col-sm-12">
												<select class="form-control kt-selectpicker" name='levelCode'>
													<option value="01">상</option>
													<option value="02">중</option>
													<option value="03">하</option>
												</select>
											</div>
											</div>
											...
											<div class="form-group row">
												...
												<div class="col-lg-7 col-md-9 col-sm-12">
													<textarea name="contents" class="form-control" data-provide="markdown" rows="20" cols="30"></textarea>
												</div>
											</div>
