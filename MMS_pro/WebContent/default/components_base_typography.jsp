								...
								<li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--open kt-menu__item--here" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
									...
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
											...
											<li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true"><a href="components_base_typography.html" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Typography</span></a></li>
										...
										<div class="kt-portlet__body">
											...
											<div class="kt-section">
												...
												<div class="kt-section__content kt-section__content--solid">
													...
													<p><span class="kt-font-bold">Example bold text</span></p>
													<p><span class="kt-font-bolder">Example bolder text</span></p>
													<p><span class="kt-font-boldest">Example boldest text</span></p>
													<p><span class="kt-font-transform-u">Example uppercase text</span></p>
												</div>
											</div>
											...
											<div class="kt-section">
												...
												<div class="kt-section__content kt-section__content--solid">
													<p><span class="kt-font-success">Success state text</span></p>
													<p><span class="kt-font-warning">Warning state text</span></p>
													<p><span class="kt-font-info">Info state text</span></p>
													<p><span class="kt-font-danger">Danger state text</span></p>
													<p><span class="kt-font-primary">Primary state text</span></p>
												</div>
											</div>
									...
									<div class="kt-portlet kt-portlet--tab">
										...
										<div class="kt-portlet__body">
											...
											<div class="kt-section">
												...
												<div class="kt-section__content kt-section__content--solid">
													<p><a href="#" class="kt-link">Example link</a></p>
													<p><a href="#" class="kt-link kt-font-bold">Example bold link</a></p>
													<p><a href="#" class="kt-link kt-font-bolder">Example bolder link</a></p>
													<p><a href="#" class="kt-link kt-font-boldest">Example boldest link</a></p>
													<p><a href="#" class="kt-link kt-font-transform-u">Example uppercase link</a></p>
												</div>
											</div>
											...
											<div class="kt-section">
												...
												<div class="kt-section__content kt-section__content--solid">
													<p><a href="#" class="kt-link kt-link--state kt-link--success">Success state</a></p>
													<p><a href="#" class="kt-link kt-link--state kt-link--warning">Warning state</a></p>
													<p><a href="#" class="kt-link kt-link--state kt-link--info">Info state</a></p>
													<p><a href="#" class="kt-link kt-link--state kt-link--danger">Danger state</a></p>
													<p><a href="#" class="kt-link kt-link--state kt-link--primary">Primary state</a></p>
												</div>
											</div>
