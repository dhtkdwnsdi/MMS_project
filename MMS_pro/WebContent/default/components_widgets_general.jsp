								...
								<li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--open kt-menu__item--here" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
									...
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
											...
											<li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true"><a href="components_widgets_general.html" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">General</span></a></li>
										</ul>
									</div>
								</li>
								<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
											...
											<div class="kt-widget30" id="kt_earnings_widget">
												<div class="kt-widget30__head">
													<div class="owl-carousel">
														<div class="carousel"><span>KeenThemes</span><span>Admin Themes</span></div>
														<div class="carousel"><span>Loopers</span><span>WP Experts</span></div>
														<div class="carousel"><span>Incontico</span><span>Social Networks</span></div>
													</div>
												</div>
										...
										<div class="kt-portlet__body kt-margin-t-0 kt-padding-t-0">
											...
											<div class="kt-widget29">
												<div class="kt-widget29__content">
													<h3 class="kt-widget29__title">Monthly Income</h3>
												...
												<div class="kt-widget29__content">
													<h3 class="kt-widget29__title">Taxes info</h3>
													<div class="kt-widget29__item">
														<div class="kt-widget29__info">
															<span class="kt-widget29__subtitle">Total</span>
															<span class="kt-widget29__stats kt-font-success">22.50</span>
														</div>
														<div class="kt-widget29__info">
															<span class="kt-widget29__subtitle">Change</span>
															<span class="kt-widget29__stats kt-font-brand">+15%</span>
														...
														<div class="kt-widget29__info">
															<span class="kt-widget29__subtitle">Count</span>
															<span class="kt-widget29__stats kt-font-danger">701</span>
														</div>
													</div>
												</div>
												<div class="kt-widget29__content">
													<h3 class="kt-widget29__title">Partners Sale</h3>
													<div class="kt-widget29__item">
														<div class="kt-widget29__info">
															<span class="kt-widget29__subtitle">Total</span>
															<span class="kt-widget29__stats kt-font-success">$680</span>
