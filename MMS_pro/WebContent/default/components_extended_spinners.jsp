								...
								<li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--open kt-menu__item--here" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
									...
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
											...
											<li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true"><a href="components_extended_spinners.html" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Spinners</span></a></li>
									...
									<div class="kt-portlet">
										...
										<div class="kt-portlet__body">
											<div class="kt-section">
												<div class="kt-section__info">Color and size options:</div>
												<div class="kt-section__content kt-section__content--solid--">
													<div class="row">
														...
														<div class="col-sm">
															<div class="kt-spinner kt-spinner--sm kt-spinner--success"></div>
														</div>
														<div class="col-sm">
												...
												<div class="kt-section__info">Using with buttons:</div>
												<div class="kt-section__content kt-section__content--solid--">
													<button class="btn btn-outline-success kt-spinner kt-spinner--sm kt-spinner--danger">Button</button>&nbsp;
													<button class="btn btn-brand kt-spinner kt-spinner--right kt-spinner--sm kt-spinner--light">Button</button>&nbsp;
													<button class="btn btn-outline-brand kt-spinner kt-spinner--md kt-spinner--danger">Button</button>&nbsp;
													<div class="kt-space-20"></div>
													<button class="btn btn-primary kt-spinner kt-spinner--right kt-spinner--md kt-spinner--light">Button</button>&nbsp;
													<button class="btn btn-outline-dark kt-spinner kt-spinner--lg kt-spinner--danger">Button</button>&nbsp;
													<button class="btn btn-danger kt-spinner kt-spinner--right kt-spinner--lg kt-spinner--light">Button</button>&nbsp;
													<div class="kt-space-20"></div>
													<button class="btn btn-outline-success btn-icon"><i class="la la-user"></i></button>&nbsp;
													<button class="btn btn-brand btn-icon kt-spinner kt-spinner--center kt-spinner--sm kt-spinner--light"></button>&nbsp;
													<button class="btn btn-success btn-icon btn-circle kt-spinner kt-spinner--center kt-spinner--sm kt-spinner--light"></button>&nbsp;
													<button class="btn btn-outline-dark btn-icon kt-spinner kt-spinner--center kt-spinner--sm kt-spinner--danger"></button>&nbsp;
												</div>
												<div class="kt-separator kt-separator--space-lg kt-separator--border-dashed"></div>
												<div class="kt-section__info">Using with form controls:</div>
												<div class="kt-section__content kt-section__content--solid--">
													<div class="kt-spinner kt-spinner--sm kt-spinner--success kt-spinner--right kt-spinner--input">
														<input type="text" class="form-control" />
													</div>
													<div class="kt-space-10"></div>
													<div class="kt-spinner kt-spinner--sm kt-spinner--danger kt-spinner--left kt-spinner--input">
														<input type="text" class="form-control" />
													</div>
												</div>
											</div>
											...
											<div class="kt-section">
												...
												<div class="kt-section__content kt-section__content--solid--">
													<div class="row">
														...
														<div class="col-sm">
															<div class="kt-spinner kt-spinner--v2 kt-spinner--sm kt-spinner--success"></div>
														</div>
														<div class="col-sm">
															<div class="kt-spinner kt-spinner--v2 kt-spinner--md kt-spinner--info"></div>
														</div>
														<div class="col-sm">
															<div class="kt-spinner kt-spinner--v2 kt-spinner--md kt-spinner--danger"></div>
														</div>
														<div class="col-sm">
															<div class="kt-spinner kt-spinner--v2 kt-spinner--lg kt-spinner--dark"></div>
														</div>
														<div class="col-sm">
															<div class="kt-spinner kt-spinner--v2 kt-spinner--lg kt-spinner--warning"></div>
														</div>
													</div>
												</div>
												<div class="kt-separator kt-separator--space-lg kt-separator--border-dashed"></div>
												<div class="kt-section__info">Using with buttons:</div>
												<div class="kt-section__content kt-section__content--solid--">
													<button class="btn btn-outline-success kt-spinner kt-spinner--v2 kt-spinner--sm kt-spinner--danger">Button</button>&nbsp;
													<button class="btn btn-brand kt-spinner kt-spinner--v2 kt-spinner--right kt-spinner--sm kt-spinner--dark">Button</button>&nbsp;
													<button class="btn btn-outline-success kt-spinner kt-spinner--v2 kt-spinner--md kt-spinner--danger">Button</button>&nbsp;
													<div class="kt-space-20"></div>
													<button class="btn btn-primary kt-spinner kt-spinner--v2 kt-spinner--right kt-spinner--md kt-spinner--warning">Button</button>&nbsp;
													<button class="btn btn-outline-dark kt-spinner kt-spinner--v2 kt-spinner--lg kt-spinner--danger">Button</button>&nbsp;
													<button class="btn btn-danger kt-spinner kt-spinner--v2 kt-spinner--right kt-spinner--lg kt-spinner--success">Button</button>&nbsp;
													<div class="kt-space-20"></div>
													<button class="btn btn-outline-success btn-icon"><i class="la la-user"></i></button>&nbsp;
													<button class="btn btn-brand btn-icon kt-spinner kt-spinner--v2 kt-spinner--center kt-spinner--sm kt-spinner--primary"></button>&nbsp;
													<button class="btn btn-success btn-icon btn-circle kt-spinner kt-spinner--v2 kt-spinner--center kt-spinner--sm kt-spinner--danger"></button>&nbsp;
													<button class="btn btn-outline-dark btn-icon kt-spinner kt-spinner--v2 kt-spinner--center kt-spinner--sm kt-spinner--danger"></button>&nbsp;
												</div>
												<div class="kt-separator kt-separator--space-lg kt-separator--border-dashed"></div>
												<div class="kt-section__info">Using with form controls:</div>
												<div class="kt-section__content kt-section__content--solid--">
													<div class="kt-spinner kt-spinner--v2 kt-spinner--sm kt-spinner--success kt-spinner--right kt-spinner--input">
														<input type="text" class="form-control" />
													</div>
													<div class="kt-space-10"></div>
													<div class="kt-spinner kt-spinner--v2 kt-spinner--sm kt-spinner--danger kt-spinner--left kt-spinner--input">
														<input type="text" class="form-control" />
													</div>
												</div>
											</div>
