								...
								<li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--open kt-menu__item--here" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
									...
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
											...
											<li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true"><a href="components_base_popover.html" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Popover</span></a></li>
										...
										<div class="kt-portlet__body">
											...
											<div class="kt-section">
												...
												<div class="kt-section__content">
													<button type="button" class="btn btn-danger" data-toggle="kt-popover" title="Popover title" data-content="And here's some amazing content. It's very engaging. Right?">Click me</button>
												</div>
											</div>
											...
											<div class="kt-section">
												...
												<div class="kt-section__content kt-demo-buttons">
													<button type="button" class="btn btn-brand" data-container="body" data-toggle="kt-popover" data-placement="top" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
														Popover on top
													</button>
													<button type="button" class="btn btn-primary" data-container="body" data-toggle="kt-popover" data-placement="right" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
														Popover on right
													</button>
													<button type="button" class="btn btn-warning" data-container="body" data-toggle="kt-popover" data-placement="bottom" data-content="Vivamus
                        sagittis lacus vel augue laoreet rutrum faucibus.">
														Popover on bottom
													</button>
													<button type="button" class="btn btn-success" data-container="body" data-toggle="kt-popover" data-placement="left" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
														Popover on left
													</button>
												</div>
											</div>
											...
											<div class="kt-section">
												...
												<div class="kt-section__content">
													<a tabindex="0" class="btn btn-success" role="button" data-toggle="kt-popover" data-trigger="focus" title="Dismissible popover" data-content="And here's some amazing content. It's very engaging. Right?">Dismissible popover</a>
												</div>
											</div>
									...
									<div class="kt-portlet">
										...
										<div class="kt-portlet__body">
											...
											<div class="kt-section">
												...
												<div class="kt-section__content">
													<button type="button" class="btn btn-primary" data-toggle="kt-popover" data-trigger="focus" title="Popover title" data-html="true" data-content="And here's some amazing <b>HTML</b> content. It's very <code>engaging</code>. Right?">Click me</button>
												</div>
											</div>
											...
											<div class="kt-section">
												...
												<span class="kt-section__info">
													Offset of the popover relative to its target. For more information refer to <a class="kt-link" href="http://tether.io/#offset" target="_blank">Tether's offset docs.</a>
												</span>
												<div class="kt-section__content">
													<button type="button" class="btn btn-brand" data-container="body" data-trigger="focus" data-offset="20px 20px" data-toggle="kt-popover" data-placement="top" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
														Example 1
													</button>
													<button type="button" class="btn btn-success" data-container="body" data-trigger="focus" data-offset="-20px -20px" data-toggle="kt-popover" data-placement="top" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
														Example 2
													</button>
													<button type="button" class="btn btn-danger" data-container="body" data-trigger="focus" data-offset="60px 0px" data-toggle="kt-popover" data-placement="top" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
														Example 3
													</button>
												</div>
											</div>
