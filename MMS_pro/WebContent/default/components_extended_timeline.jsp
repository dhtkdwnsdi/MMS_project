								...
								<li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--open kt-menu__item--here" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
									...
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
											...
											<li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true"><a href="components_extended_timeline.html" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Timeline</span></a></li>
										...
										<div class="col-xl-10">
												...
												<div class="kt-timeline-v1__items">
													...
													<div class="kt-timeline-v1__item kt-timeline-v1__item--left kt-timeline-v1__item--first">
														...
														<div class="kt-timeline-v1__item-content">
															...
															<div class="kt-timeline-v1__item-actions">
																<a href="#" class="btn btn-sm btn-outline-brand">Show more ...</a>
															</div>
														</div>
													</div>
															...
															<div class="kt-timeline-v1__item-body">
																<div class="kt-widget4">
																	<div class="kt-widget4__item">
																		...
																		<a href="#" class="btn btn-sm btn-outline-success btn-bold">Check</a>
																	</div>
																	<div class="kt-widget4__item">
																		<div class="kt-widget4__pic">
													...
													<div class="kt-timeline-v1__item kt-timeline-v1__item--left">
														...
														<div class="kt-timeline-v1__item-content">
															...
															<div class="kt-timeline-v1__item-actions">
																<a href="#" class="btn btn-sm btn-outline-danger">View more...</a>
															</div>
														</div>
													</div>
													<div class="kt-timeline-v1__item kt-timeline-v1__item--right">
														...
														<div class="kt-timeline-v1__item-content">
															...
															<div class="kt-timeline-v1__item-actions">
																<a href="#" class="btn btn-sm btn-outline-success">Check all...</a>
															</div>
														</div>
													</div>
												</div>
											...
											<div class="row">
												<div class="col kt-align-center">
													<button type="button" class="btn btn-outline-brand">Load More...</button>
												</div>
											</div>
										</div>
										<div class="col-xl-1">
