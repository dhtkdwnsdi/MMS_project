...
<html lang="en">
	...
	<body class="kt-header--fixed kt-header-mobile--fixed kt-subheader--fixed kt-subheader--enabled kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
								...
								<li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--open kt-menu__item--here" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
									...
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
											...
											<li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true"><a href="components_maps_jqvmap.html" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">JQVMap</span></a></li>
										</ul>
									</div>
								</li>
								<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
						...
						<div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
							<div class="alert alert-light alert-elevate" role="alert">
								...
								<div class="alert-text">
									...
									For more info please check out <a class="kt-link kt-link--brand kt-font-bold" href="http://jqvmap.com/" target="_blank">the official documentation.</a>
								</div>
							</div>
							<div class="row">
								<div class="col-lg-6">
									...
									<div class="kt-portlet kt-portlet--tab">
										...
										<div class="kt-portlet__body">
											<div id="kt_jqvmap_usa" class="kt-jqvmap" style="height:300px;"></div>
										</div>
									</div>
									...
									<div class="kt-portlet kt-portlet--tab">
										...
										<div class="kt-portlet__body">
											<div id="kt_jqvmap_europe" class="kt-jqvmap" style="height:300px;"></div>
										</div>
									</div>
								...
								<div class="col-lg-6">
									...
									<div class="kt-portlet kt-portlet--tab">
										...
										<div class="kt-portlet__body">
											<div id="kt_jqvmap_russia" class="kt-jqvmap" style="height:300px;"></div>
										</div>
									</div>
									...
									<div class="kt-portlet kt-portlet--tab">
										...
										<div class="kt-portlet__body">
											<div id="kt_jqvmap_germany" class="kt-jqvmap" style="height:300px;"></div>
										</div>
									</div>
		...
		<script src="../assets/app/custom/general/components/maps/jqvmap.js" type="text/javascript"></script>
