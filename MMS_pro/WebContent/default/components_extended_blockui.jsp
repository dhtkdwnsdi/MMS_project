								...
								<li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--open kt-menu__item--here" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
									...
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
											...
											<li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true"><a href="components_extended_blockui.html" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Block UI</span></a></li>
						...
						<div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
							<div class="row">
										...
										<div class="kt-portlet__body">
											...
											<div class="kt-section">
												...
												<div class="kt-section__content">
													...
													<button type="button" class="btn btn-success" id="kt_blockui_1_1">Default</button>
													<button type="button" class="btn btn-brand" id="kt_blockui_1_2">Overlay color</button>
													<button type="button" class="btn btn-primary" id="kt_blockui_1_3">Custom spinner</button>
													<button type="button" class="btn btn-info" id="kt_blockui_1_4">Custom text 1</button>
													<button type="button" class="btn btn-danger" id="kt_blockui_1_5">Custom text 2</button>
												</div>
											</div>
									...
									<div class="kt-portlet">
										...
										<div class="kt-portlet__body">
											...
											<div class="kt-section">
												...
												<div class="kt-section__content">
													<button type="button" class="btn btn-success" data-toggle="modal" data-target="#kt_blockui_4_1_modal">Default</button>
													<button type="button" class="btn btn-brand" data-toggle="modal" data-target="#kt_blockui_4_2_modal">Overlay color</button>
													<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#kt_blockui_4_3_modal">Custom spinner</button>
													<button type="button" class="btn btn-info" data-toggle="modal" data-target="#kt_blockui_4_4_modal">Custom text 1</button>
													<button type="button" class="btn btn-danger" data-toggle="modal" data-target="#kt_blockui_4_5_modal">Custom text 2</button>
												</div>
											</div>
								...
								<div class="col-xl-6">
									...
									<!--begin::Portlet-->
									<div class="kt-portlet" id="kt_blockui_2_portlet">
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title">
													Portlet Blocking
										...
										<div class="kt-portlet__body">
											...
											<div class="kt-section">
												...
												<div class="kt-section__content">
													<button type="button" class="btn btn-success" id="kt_blockui_2_1">Default</button>
													<button type="button" class="btn btn-brand" id="kt_blockui_2_2">Overlay color</button>
													<button type="button" class="btn btn-primary" id="kt_blockui_2_3">Custom spinner</button>
													<button type="button" class="btn btn-info" id="kt_blockui_2_4">Custom text 1</button>
													<button type="button" class="btn btn-danger" id="kt_blockui_2_5">Custom text 2</button>
												</div>
											</div>
									...
									<div class="kt-portlet">
										...
										<div class="kt-portlet__body">
											...
											<div class="kt-section">
												...
												<div class="kt-section__content">
													<button type="button" class="btn btn-success" id="kt_blockui_3_1">Default</button>
													<button type="button" class="btn btn-brand" id="kt_blockui_3_2">Overlay color</button>
													<button type="button" class="btn btn-primary" id="kt_blockui_3_3">Custom spinner</button>
													<button type="button" class="btn btn-info" id="kt_blockui_3_4">Custom text 1</button>
													<button type="button" class="btn btn-danger" id="kt_blockui_3_5">Custom text 2</button>
												</div>
											</div>
								...
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										...
										<div class="modal-footer">
											...
											<button type="button" class="btn btn-primary" id="kt_blockui_4_1">Block modal</button>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="modal fade" id="kt_blockui_4_2_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										...
										<div class="modal-footer">
											<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
											<button type="button" class="btn btn-primary" id="kt_blockui_4_2">Block modal</button>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="modal fade" id="kt_blockui_4_3_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										...
										<div class="modal-footer">
											<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
											<button type="button" class="btn btn-primary" id="kt_blockui_4_3">Block modal</button>
										</div>
									</div>
								</div>
							</div>
							...
							<!--begin::Modal-->
							<div class="modal fade" id="kt_blockui_4_4_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										<div class="modal-header">
											<h5 class="modal-title" id="exampleModalLabel">New message</h5>
							...
							<!--begin::Modal-->
							<div class="modal fade" id="kt_blockui_4_5_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										<div class="modal-header">
											<h5 class="modal-title" id="exampleModalLabel">New message</h5>
										...
										<div class="modal-footer">
											<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
											<button type="button" class="btn btn-primary" id="kt_blockui_4_5">Block modal</button>
										</div>
									</div>
								</div>
							</div>
