								...
								<li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--open kt-menu__item--here" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
									...
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
											...
											<li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true"><a href="components_extended_navs.html" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Navigations</span></a></li>
								...
								<div class="col-lg-6">
									...
									<div class="kt-portlet">
										...
										<div class="kt-portlet__body">
													...
													<ul class="kt-nav">
														...
														<li class="kt-nav__item">
															<a href="#" class="kt-nav__link">
																...
																<span class="kt-nav__link-badge">
																	<span class="kt-badge kt-badge--success kt-badge--inline kt-badge--pill">23</span>
																</span>
															</a>
														</li>
													</ul>
											...
											<!--begin::Dropdown-->
											<div class="dropdown">
												<a href="#" class="btn btn-brand dropdown-toggle" data-toggle="dropdown">
													Dropdown example
												</a>
										...
										<div class="kt-portlet__body">
											...
											<div class="kt-section">
												<div class="kt-section__content kt-section__content--solid kt-section__content--fit">
													<ul class="kt-nav">
														<li class="kt-nav__section kt-nav__section--first">
															<span class="kt-nav__section-text">Section 1</span>
														</li>
														<li class="kt-nav__item">
															<a href="#" class="kt-nav__link">
																<i class="kt-nav__link-icon flaticon-share"></i>
														...
														<li class="kt-nav__section">
															<span class="kt-nav__section-text">Section 2</span>
														</li>
														<li class="kt-nav__item">
															<a href="#" class="kt-nav__link">
																<i class="kt-nav__link-icon flaticon-lifebuoy"></i>
														...
														<li class="kt-nav__item kt-nav__item--custom">
															<a href="#" class="btn btn-outline-danger btn-pill btn-wide btn-sm">Logout</a>
														</li>
													</ul>
												</div>
											</div>
												...
												<div class="kt-section__content kt-section__content--solid kt-section__content--fit">
													<ul class="kt-nav">
														...
														<li class="kt-nav__item">
															<a href="#" class="kt-nav__link">
																<i class="kt-nav__link-icon flaticon-chat-1"></i>
																<span class="kt-nav__link-text">Link</span>
															</a>
														</li>
														<li class="kt-nav__item kt-nav__item--disabled">
															<a href="#" class="kt-nav__link">
																<i class="kt-nav__link-icon flaticon-info"></i>
																<span class="kt-nav__link-text">Disabled</span>
															</a>
														</li>
														<li class="kt-nav__item">
															<a href="#" class="kt-nav__link">
													...
													<div class="kt-section">
														...
														<div class="kt-section__content kt-section__content--solid kt-section__content--fit">
															<ul class="kt-nav kt-nav--active-bg" id="kt_nav" role="tablist">
																...
																<li class="kt-nav__item kt-nav__item--active">
																	<a class="kt-nav__link  collapsed" role="tab" id="kt_nav_link_2" data-toggle="collapse" href="#kt_nav_sub_2" aria-expanded="  false">
																		<i class="kt-nav__link-icon flaticon-info"></i>
								...
								<div class="col-lg-6">
									...
									<div class="kt-portlet">
										...
										<div class="kt-portlet__body">
											...
											<!--begin::Section-->
											<div class="kt-section">
												<span class="kt-section__info">Nav items can have dot and line style bullets:</span>
												<div class="kt-section__content kt-section__content--solid kt-section__content--fit">
													<ul class="kt-nav">
														<li class="kt-nav__item">
															<a href="#" class="kt-nav__link">
													...
													<div class="kt-grid-nav">
														<div class="kt-grid-nav__row">
															<a href="#" class="kt-grid-nav__item">
																...
																<span class="kt-grid-nav__title">Generate Report</span>
															</a>
															<a href="#" class="kt-grid-nav__item">
																<i class="kt-grid-nav__icon flaticon-time"></i>
																<span class="kt-grid-nav__title">New Event</span>
															</a>
															<a href="#" class="kt-grid-nav__item">
																<i class="kt-grid-nav__icon flaticon-user"></i>
																<span class="kt-grid-nav__title">Add Member</span>
															</a>
														</div>
														<div class="kt-grid-nav__row">
															<a href="#" class="kt-grid-nav__item">
																<i class="kt-grid-nav__icon flaticon-folder"></i>
																<span class="kt-grid-nav__title">Create New Task</span>
															</a>
															<a href="#" class="kt-grid-nav__item">
																<i class="kt-grid-nav__icon flaticon-clipboard"></i>
																<span class="kt-grid-nav__title">Completed Tasks</span>
															</a>
															<a href="#" class="kt-grid-nav__item">
																<i class="kt-grid-nav__icon flaticon-interface-3"></i>
																<span class="kt-grid-nav__title">Check Logs</span>
															</a>
														</div>
													</div>
												</div>
													...
													<ul class="kt-nav kt-nav--bold kt-nav--md-space kt-nav--v3 kt-margin-t-20 kt-margin-b-20" role="tablist">
														...
														<li class="kt-nav__item">
															<a class="kt-nav__link" data-toggle="tab" href="#kt_profile_change_password" role="tab">
																...
																<span class="kt-nav__link-text">Password</span>
															</a>
														</li>
														<li class="kt-nav__separator"></li>
														<li class="kt-nav__item">
