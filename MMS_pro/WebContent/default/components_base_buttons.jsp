								...
								<li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--open kt-menu__item--here" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
									...
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
											...
											<li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true"><a href="components_base_buttons.html" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Buttons</span></a></li>
							...
							<div class="row">
								<div class="col-xl-6">
									...
									<div class="kt-portlet">
										...
										<div class="kt-portlet__body">
											<div class="kt-section">
												<div class="kt-section__info">Bootstrap buttons:</div>
											...
											<div class="kt-section">
												<div class="kt-section__info">The <code>.btn</code> classes are designed to be used with <code>&lt;button&gt;</code>, <code>&lt;a&gt;</code> and <code>&lt;input&gt;</code> elements.</div>
												<div class="kt-section__content kt-section__content--solid">
											...
											<div class="kt-separator kt-separator--space-sm  kt-separator--border-dashed"></div>
											<div class="kt-section">
												<div class="kt-section__info">Button states:</div>
												<div class="kt-section__content kt-section__content--solid">
											...
											<div class="kt-separator kt-separator--space-sm  kt-separator--border-dashed"></div>
											<div class="kt-section">
												<div class="kt-section__info">Metronic custom buttons:</div>
												<div class="kt-section__content kt-section__content--solid">
													<button type="button" class="btn btn-brand">Brand</button>
											...
											<div class="kt-separator kt-separator--space-sm  kt-separator--border-dashed"></div>
											<div class="kt-section">
												<div class="kt-section__info">Metronic base buttons:</div>
												<div class="kt-section__content kt-section__content--solid">
									...
									<div class="kt-portlet">
										...
										<div class="kt-portlet__body">
											<div class="kt-section">
												<div class="kt-section__info">Large buttons:</div>
												<div class="kt-section__content kt-section__content--solid">
											...
											<div class="kt-separator kt-separator--space-sm  kt-separator--border-dashed"></div>
											<div class="kt-section">
												<div class="kt-section__info">Small buttons:</div>
												<div class="kt-section__content kt-section__content--solid">
											...
											<div class="kt-separator kt-separator--space-sm  kt-separator--border-dashed"></div>
											<div class="kt-section">
												<div class="kt-section__info">Font settings:</div>
												<div class="kt-section__content kt-section__content--solid">
											...
											<div class="kt-separator kt-separator--space-sm  kt-separator--border-dashed"></div>
											<div class="kt-section">
												<div class="kt-section__info">Wide buttons:</div>
												<div class="kt-section__content kt-section__content--solid">
											...
											<div class="kt-separator kt-separator--space-sm  kt-separator--border-dashed"></div>
											<div class="kt-section">
												<div class="kt-section__info">Tall buttons:</div>
												<div class="kt-section__content kt-section__content--solid">
									...
									<div class="kt-portlet">
										...
										<div class="kt-portlet__body">
											<div class="kt-section">
												<div class="kt-section__info">Default outline buttons:</div>
												<div class="kt-section__content kt-section__content--solid">
											...
											<div class="kt-separator kt-separator--space-sm  kt-separator--border-dashed"></div>
											<div class="kt-section">
												<div class="kt-section__info">Hover outline buttons:</div>
												<div class="kt-section__content kt-section__content--solid">
									...
									<div class="kt-portlet">
										...
										<div class="kt-portlet__body">
											<div class="kt-section">
												<div class="kt-section__info">Default effect:</div>
												<div class="kt-section__content kt-section__content--solid">
													<button type="button" class="btn btn-light btn-elevate">Light</button>&nbsp;
											...
											<div class="kt-separator kt-separator--space-sm  kt-separator--border-dashed"></div>
											<div class="kt-section">
												<div class="kt-section__info">Hover elevate effect:</div>
												<div class="kt-section__content kt-section__content--solid">
								...
								<div class="col-xl-6">
									...
									<div class="kt-portlet">
										...
										<div class="kt-portlet__body">
											<div class="kt-section">
												<div class="kt-section__info">Default options:</div>
												<div class="kt-section__content kt-section__content--solid">
											...
											<div class="kt-separator kt-separator--space-sm  kt-separator--border-dashed"></div>
											<div class="kt-section">
												<div class="kt-section__info">Elevation options:</div>
												<div class="kt-section__content kt-section__content--solid">
									...
									<div class="kt-portlet">
										...
										<div class="kt-portlet__body">
											<div class="kt-section">
												<div class="kt-section__info">Default options with Fontawesome 5 icons:</div>
												<div class="kt-section__content kt-section__content--solid">
											...
											<div class="kt-separator kt-separator--space-sm  kt-separator--border-dashed"></div>
											<div class="kt-section">
												<div class="kt-section__info">Elevation options with Lineawesome icons:</div>
												<div class="kt-section__content kt-section__content--solid">
											...
											<div class="kt-separator kt-separator--space-sm  kt-separator--border-dashed"></div>
											<div class="kt-section">
												<div class="kt-section__info">Pill options with Flaticon icons:</div>
												<div class="kt-section__content kt-section__content--solid">
											...
											<div class="kt-separator kt-separator--space-sm  kt-separator--border-dashed"></div>
											<div class="kt-section">
												<div class="kt-section__info">Size options:</div>
												<div class="kt-section__content kt-section__content--solid">
									...
									<div class="kt-portlet">
										...
										<div class="kt-portlet__body">
											...
											<div class="kt-separator kt-separator--space-sm  kt-separator--border-dashed"></div>
											<div class="kt-section">
												<div class="kt-section__info">Circle options with Flaticon icons:</div>
												<div class="kt-section__content kt-section__content--solid">
									...
									<div class="kt-portlet">
										...
										<div class="kt-portlet__body">
											<div class="kt-section">
												<div class="kt-section__info">You can use the buttons styles for labels with <code>span</code> tag:</div>
												<div class="kt-section__content kt-section__content--solid">
											...
											<div class="kt-separator kt-separator--space-sm  kt-separator--border-dashed"></div>
											<div class="kt-section">
												<div class="kt-section__info">Label pill style:</div>
												<div class="kt-section__content kt-section__content--solid">
											...
											<div class="kt-separator kt-separator--space-sm  kt-separator--border-dashed"></div>
											<div class="kt-section">
												<div class="kt-section__info">Link labels:</div>
												<div class="kt-section__content kt-section__content--solid">
											...
											<div class="kt-separator kt-separator--space-sm  kt-separator--border-dashed"></div>
											<div class="kt-section">
												<div class="kt-section__info">Label sizing:</div>
												<div class="kt-section__content kt-section__content--solid">
													<span class="btn btn-label-primary btn-sm">Primary</span>&nbsp;
													<span class="btn btn-label-success btn-sm">Success</span>&nbsp;
													<span class="btn btn-label-info btn-sm">Info</span>&nbsp;
													<span class="btn btn-label-danger btn-sm">Danger</span>&nbsp;
													<span class="btn btn-label-warning btn-sm">Warning</span>&nbsp;
												</div>
											</div>
										</div>
									</div>
