...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>Metronic | Perfect Scrollbar</title>
								...
								<li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--open kt-menu__item--here" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
									...
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
											...
											<li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true"><a href="components_extended_perfect-scrollbar.html" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Perfect Scrollbar</span></a></li>
							...
							<div class="row">
										...
										<div class="kt-portlet__body">
											...
											<div class="kt-section kt-section--last">
												...
												<div class="kt-section__content">
													<button type="button" class="btn btn-success" data-toggle="modal" data-target="#kt_scrollable_modal_1">Launch Modal</button>
												</div>
											</div>
								...
								<div class="col-lg-6">
									...
									<div class="kt-portlet">
										...
										<div class="kt-portlet__body">
											<div class="kt-scroll" data-scroll="true" data-scroll-x="true" style="height: 200px">
