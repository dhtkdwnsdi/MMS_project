								...
								<li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--open kt-menu__item--here" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
									...
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
											...
											<li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true"><a href="components_base_tooltip.html" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Tooltip</span></a></li>
										</ul>
									</div>
								</li>
								<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
										...
										<div class="kt-portlet__body">
											...
											<div class="kt-section">
												...
												<div class="kt-section__content">
													<button type="button" class="btn btn-danger" data-toggle="kt-tooltip" data-placement="left" title="Tooltip title">Click me</button>
												</div>
											</div>
											...
											<div class="kt-section">
												...
												<div class="kt-section__content">
													<button type="button" class="btn btn-brand" data-container="body" data-toggle="kt-tooltip" data-placement="top" title="Tooltip title">
														Tooltip on top
													</button>
													<div class="kt-space-10"></div>
													<button type="button" class="btn btn-primary" data-container="body" data-toggle="kt-tooltip" data-placement="right" title="Tooltip title">
														Tooltip on right
													</button>
													<div class="kt-space-10"></div>
													<button type="button" class="btn btn-warning" data-container="body" data-toggle="kt-tooltip" data-placement="bottom" title="Tooltip title">
														Tooltip on bottom
													</button>
													<div class="kt-space-10"></div>
													<button type="button" class="btn btn-success" data-container="body" data-container="body" data-toggle="kt-tooltip" data-placement="left" title="Tooltip title">
														Tooltip on left
													</button>
												</div>
											</div>
											...
											<div class="kt-section">
												...
												<div class="kt-section__content">
													<a tabindex="0" class="btn btn-success" role="button" data-toggle="kt-tooltip" data-trigger="focus" title="Dismissible tooltip" data-content="And here's some amazing content. It's very engaging. Right?">Dismissible tooltip</a>
												</div>
											</div>
									...
									<div class="kt-portlet">
										...
										<div class="kt-portlet__body">
											...
											<div class="kt-section">
												...
												<div class="kt-section__content">
													<button type="button" class="btn btn-primary" data-toggle="kt-tooltip" title="Tooltip <b>with</b> <code>HTML</code>" data-html="true" data-content="And here's some amazing <b>HTML</b> content. It's very <code>engaging</code>. Right?">Click me</button>
												</div>
											</div>
											...
											<div class="kt-section">
												...
												<span class="kt-section__info">
													Offset of the tooltip relative to its target. For more information refer to <a class="kt-link" href="http://tether.io/#offset" target="_blank">Tether's offset docs.</a>
												</span>
												<div class="kt-section__content">
													<button type="button" class="btn btn-brand" data-offset="20px 20px" data-toggle="kt-tooltip" data-placement="top" title="Tooltip title">
														Example 1
													</button>
													<button type="button" class="btn btn-success" data-offset="-20px -20px" data-toggle="kt-tooltip" data-placement="top" title="Tooltip title">
														Example 2
													</button>
													<button type="button" class="btn btn-danger" data-offset="60px 0px" data-toggle="kt-tooltip" data-placement="top" title="Tooltip title">
														Example 3
													</button>
												</div>
											</div>
											...
											<div class="kt-section">
												...
												<div class="kt-section__content">
													<button type="button" class="btn btn-default" data-toggle="kt-tooltip" data-placement="top" title="Default light skin">
														Light skin
													</button>
													<button type="button" class="btn btn-brand" data-skin="brand" data-toggle="kt-tooltip" data-placement="top" title="Brand skin">
														Brand skin
													</button>
													<button type="button" class="btn btn-dark" data-skin="dark" data-toggle="kt-tooltip" data-placement="top" title="Dark skin">
														Dark skin
													</button>
												</div>
											</div>
