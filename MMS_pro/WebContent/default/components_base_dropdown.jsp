								...
								<li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--open kt-menu__item--here" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
									...
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
											...
											<li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true"><a href="components_base_dropdown.html" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Dropdown</span></a></li>
								...
								<div class="col-md-6">
									...
									<div class="kt-portlet">
										...
										<div class="kt-portlet__body">
											...
											<div class="kt-section">
												<span class="kt-section__info">Single button dropdowns:</span>
											...
											<!--begin::Section-->
											<div class="kt-section">
												<span class="kt-section__info">Dropdown menu with icons:</span>
												<div class="kt-section__content">
													<div class="row">
														<div class="col">
															<div class="dropdown">
											...
											<!--begin::Section-->
											<div class="kt-section">
												<span class="kt-section__info">Button state dropdowns:</span>
												<div class="kt-section__content">
													<div class="btn-group">
											...
											<!--begin::Section-->
											<div class="kt-section">
												<span class="kt-section__info">Single icon button dropdowns:</span>
												<div class="kt-section__content">
									...
									<div class="kt-portlet">
										...
										<div class="kt-portlet__body">
											...
											<!--begin::Section-->
											<div class="kt-section">
												<span class="kt-section__info">Button dropdowns work with buttons of all sizes, including default and split dropdown buttons.</span>
												<div class="kt-section__content">
													<div class="btn-group">
								...
								<div class="col-md-6">
									...
									<div class="kt-portlet">
										...
										<div class="kt-portlet__body">
											...
											<!--begin::Section-->
											<div class="kt-section">
												<span class="kt-section__info">Trigger dropdown menus above elements by adding <code>.dropup</code> to the parent element.</span>
												<div class="kt-section__content">
													<div class="row">
														<div class="col">
									...
									<div class="kt-portlet">
										...
										<div class="kt-portlet__body">
											...
											<!--begin::Section-->
											<div class="kt-section">
												<span class="kt-section__info">You can optionally use <code>button</code> elements for your dropdowns items.</span>
												<div class="kt-section__content">
													<div class="row">
														<div class="col">
															<div class="dropdown">
											...
											<!--begin::Section-->
											<div class="kt-section">
												<span class="kt-section__info">Add <code>.dropdown-menu-right</code> to a <code>.dropdown-menu</code> to right align the dropdown menu.</span>
												<div class="kt-section__content">
													<div class="row">
														<div class="col">
															<div class="btn-group">
											...
											<!--begin::Section-->
											<div class="kt-section">
												<span class="kt-section__info">Add a header to label sections of actions in any dropdown menu.</span>
												<div class="kt-section__content">
													<div class="row">
														<div class="col">
															<div class="btn-group">
											...
											<!--begin::Section-->
											<div class="kt-section">
												<span class="kt-section__info">Separate groups of related menu items with a divider.</span>
												<div class="kt-section__content">
													<div class="row">
														<div class="col">
															<div class="btn-group">
											...
											<!--begin::Section-->
											<div class="kt-section">
												<span class="kt-section__info">Add <code>.disabled</code> to items in the dropdown to style them as disabled.</span>
												<div class="kt-section__content">
													<div class="row">
														<div class="col">
															<div class="btn-group">
