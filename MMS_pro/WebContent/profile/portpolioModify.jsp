											...
											<div class="form-group row">
												...
												<div class="col-4">
													<select name="portCate" class="form-control" id="portCate">
														<c:if test="${portCate == '카테고리1'}"> 
														<option value="">Select</option>
														<option value="C1" selected="selected">카테고리1</option>
														<option value="C2">카테고리2</option>
														<option value="C3">카테고리3</option>
														</c:if>
														
														<c:if test="${portCate == '카테고리2'}"> 
														<option value="">Select</option>
														<option value="C1">카테고리1</option>
														<option value="C2" selected="selected">카테고리2</option>
														<option value="C3">카테고리3</option>
														</c:if>
														
														<c:if test="${portCate == '카테고리3'}"> 
														<option value="">Select</option>
														<option value="C1">카테고리1</option>
														<option value="C2">카테고리2</option>
														<option value="C3" selected="selected">카테고리3</option>
														</c:if>
													</select>
												</div>
											</div>
											<div class="form-group row">
												...
												<div class="col-4">
													<select name="portDetailCate" class="form-control" id="portDetailCate">
														<c:if test="${portDetailCate == '카테고리1'}"> 
														<option value="">Select</option>
														<option value="DC1" selected="selected">카테고리1</option>
														<option value="DC2">카테고리2</option>
														<option value="DC3">카테고리3</option>
														</c:if>
														
														<c:if test="${portDetailCate == '카테고리2'}"> 
														<option value="">Select</option>
														<option value="DC1">카테고리1</option>
														<option value="DC2" selected="selected">카테고리2</option>
														<option value="DC3">카테고리3</option>
														</c:if>
														
														<c:if test="${portDetailCate == '카테고리3'}"> 
														<option value="">Select</option>
														<option value="DC1">카테고리1</option>
														<option value="DC2">카테고리2</option>
														<option value="DC3" selected="selected">카테고리3</option>
														</c:if>
													</select>
												</div>
											</div>
