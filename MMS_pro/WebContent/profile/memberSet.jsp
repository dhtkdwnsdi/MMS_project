													...
													<div class="col-xl-8">
														<div class="kt-section kt-section--first">
															<div class="kt-section__body">
																<h3 class="kt-section__title kt-section__title-lg">${LoginUser.name} 님의 정보</h3>
																<div class="form-group row">
																	<label class="col-3 col-form-label">아이디</label>
																	<div class="col-9">
																		<input class="form-control" type="text" value="${LoginUser.id}" readonly="readonly">
																	</div>
																</div>
																<div class="form-group row">
																	<label class="col-3 col-form-label">비밀번호</label>
																	<div class="col-9">
																		<input class="form-control" type="password" value="${LoginUser.password}" readonly="readonly">
																	</div>
																</div>
																<div class="form-group row">
																	<label class="col-3 col-form-label">이름</label>
																	<div class="col-9">
																		<input class="form-control" type="text" value="${LoginUser.name}" readonly="readonly">
																	</div>
																</div>
																<div class="form-group row">
																	<label class="col-3 col-form-label">주소</label>
																	<div class="col-9">
																		<input class="form-control" type="text" value="${LoginUser.juso}" readonly="readonly">
																	</div>
																</div>
																<div class="form-group row">
																	<label class="col-3 col-form-label">상세 주소</label>
																	<div class="col-9">
																		<input class="form-control" type="text" value="${LoginUser.extraJuso}" readonly="readonly">
																	</div>
																</div>
																<div class="form-group row">
																	...
																	<div class="col-9">
																		<div class="input-group">
																			...
																			<input type="text" class="form-control" value="${LoginUser.email}" placeholder="Email" aria-describedby="basic-addon1" readonly="readonly">
																		</div>
																	</div>
																</div>
																<div class="form-group row">
																	...
																	<div class="col-9">
																		<div class="input-group">
																			...
																			<input type="text" class="form-control" value="${LoginUser.tel}" placeholder="Phone" aria-describedby="basic-addon1" readonly="readonly">
																		</div>
																	</div>
																</div>
																<div class="form-group row">
																	...
																	<div class="col-9">
																		<input class="form-control" type="text" value="${LoginUser.bank}" readonly="readonly">
																	</div>
																</div>
																<div class="form-group row">
																	<label class="col-3 col-form-label">계좌번호</label>
																	<div class="col-9">
																		<input class="form-control" type="text" value="${LoginUser.account}" readonly="readonly">
																	</div>
																</div>
															</div>
														</div>
														<div class="kt-separator kt-separator--border-dashed kt-separator--space-lg"></div>
														<input type="submit" value="수정" style="float: right;" class="btn btn-primary">
	 												</div>
													<div class="col-xl-2"></div>
												</div>
											</form>
