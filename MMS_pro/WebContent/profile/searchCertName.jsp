								...
								<c:forEach items="${certList}" var="CertVO">
									<tbody>
										<tr>
											...
											<a onclick= "return sendToParent()">${CertVO.certNum}</td>
											<td><input type="hidden" name="certNum" value = "${CertVO.certNum}">
											<a onclick= "return sendToParent()">${CertVO.certName}</td>
											<td><input type="hidden" name="certNum" value = "${CertVO.certNum}">
											<a onclick= "return sendToParent()">${CertVO.issueOrg}</td>
										</tr>
									</tbody>
								</c:forEach>
							</table>
				...
				<div class="kt-notification">
					<a href="#" class="kt-notification__item">
						...
						<div class="kt-notification__item-details">
							<div class="kt-notification__item-title">New order has been
								received</div>
						...
						<div class="kt-notification__item-details">
							<div class="kt-notification__item-title">Finance report has
								been generated</div>
				...
				<div class="kt-notification-v2">
					<a href="#" class="kt-notification-v2__item">
						...
						<div class="kt-notification-v2__itek-wrapper">
							...
							<div class="kt-notification-v2__item-desc">Reports based on
								sales</div>
						</div>
						...
						<div class="kt-notification-v2__itek-wrapper">
							<div class="kt-notification-v2__item-title">4.5h-avarage
								response time</div>
							<div class="kt-notification-v2__item-desc">Fostest is Barry
							</div>
						</div>
					</a> <a href="#" class="kt-notification-v2__item">
						<div class="kt-notification-v2__item-icon">
						...
						<div class="kt-notification-v2__itek-wrapper">
							<div class="kt-notification-v2__item-title">Database server
								is down</div>
			...
			<div
				...
				<form class="kt-form">
					...
					<div class="form-group form-group-xs row">
						...
						<div class="col-4 kt-align-right">
							<span class="kt-switch kt-switch--sm kt-switch--danger"> <label>
