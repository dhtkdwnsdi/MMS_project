										...
										<thead style="text-align: center;">
                                          ...
                                          <tbody style="text-align: center;">
                                             <tr>
                                                ...
                                                <input type="hidden" value="${PortpolioVo.portNum}" id="portNum" name="portNum"></tH>
                                                <td>${PortpolioVo.subject}</td>
                                                <td>${PortpolioVo.portCate} &nbsp;&nbsp; >> &nbsp;&nbsp;
                                                ${PortpolioVo.portDetailCate} </td>
                                             </tr>
                                          </tbody>
                                          </c:forEach>
												</c:when>
