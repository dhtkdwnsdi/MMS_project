...
<body
	...
	<form role="form" name="frm" method="post"
		action="prog?command=insertEdu" class="form-horizontal">
		<!-- 
			...
			<div class="kt-portlet">
				<div class="kt-portlet__head">
					<div class="kt-portlet__head-label">
						<h3 class="kt-portlet__head-title">학력등록</h3>
					</div>
				</div>
				...
				<form class="kt-form kt-form--label-right">
					...
					<div class="kt-portlet__body">
						<div class="form-group row">
							<label class="col-form-label col-lg-3 col-sm-1">프로그래머번호</label>
							<div class="col-lg-4 col-md-9 col-sm-5">
								<div class="row">
									<div class="col">
										<input type="progNum" class="form-control" type="text"
					...
					<div class="kt-portlet__body">
						<div class="form-group row">
							<label class="col-form-label col-lg-3 col-sm-1">분류</label>
							<div class="col-lg-4 col-md-9 col-sm-5">
								<div class="row">
									<div class="col">
										<select class="form-control" id="eduDivision">
					...
					<div class="kt-portlet__body">
						<div class="form-group row">
							<label class="col-form-label col-lg-3 col-sm-1">상태</label>
							<div class="col-lg-4 col-md-9 col-sm-5">
								<div class="row">
									<div class="col">
					...
					<div class="kt-portlet__body">
						<div class="form-group row">
							<label class="col-form-label col-lg-3 col-sm-1">학교명</label>
							<div class="col-lg-4 col-md-9 col-sm-5">
								<div class="row">
									<div class="col">
										<input type="schoolName" class="form-control"
					...
					<div class="kt-portlet__body">
						<div class="form-group row">
							<label class="col-form-label col-lg-3 col-sm-1">전공</label>
							<div class="col-lg-4 col-md-9 col-sm-5">
								<div class="row">
									<div class="col">
										<input type="major" class="form-control"
					...
					<div class="form-group row">
						<label class="col-form-label col-lg-3 col-sm-12">입학일</label>
						<div class="col-lg-9 col-md-9 col-sm-5">
							<div class="input-group date">
								<input type="text" class="form-control" readonly
									placeholder="Select date" id="kt_datepicker_1_validate"
									name='startDuedate' />
					...
					<div class="form-group row">
						<label class="col-form-label col-lg-3 col-sm-12">졸업일</label>
						<div class="col-lg-9 col-md-9 col-sm-5">
							<div class="input-group date">
								<input type="text" class="form-control" readonly
									placeholder="Select date" id="kt_datepicker_1_validate"
					...
					<!--  <button type="button" class="btn btn-primary" onclick="return eduCheck()">등록</button> -->
						<a type="button" href="/prog?command=eduListForm"
