							...
							<div class="row">
								<div class="col-xl-12">
									...
									<div class="kt-portlet kt-portlet--tabs">
										<div class="kt-portlet__head">
											...
											<div class="kt-portlet__head-toolbar">
												<ul class="nav nav-tabs nav-tabs-bold nav-tabs-line   nav-tabs-line-right nav-tabs-line-brand" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-toggle="tab" href="#kt_portlet_tab_1_6" role="tab">
															전체 리스트
														</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-toggle="tab" href="#kt_portlet_tab_1_7" role="tab">
															승인 대기 리스트
														</a>
													</li>
													<!-- <li class="nav-item">
										...
										<div class="kt-portlet__body">
											<div class="tab-content">
												<div class="tab-pane active" id="kt_portlet_tab_1_6">
													<table class="table table-bordered table-hover">
                                          <thead style="text-align: center;">
                                             <tr>
                                                <th>#</th>
                                          ...
                                          <c:if test="${empty allList}">
												...
												<div class="tab-pane" id="kt_portlet_tab_1_7">
													<table class="table table-bordered table-hover">
                                          <thead style="text-align: center;">
                                             <tr>
                                                <th>#</th>
						...
						<div class="kt-section__content">
							<table class="table table-bordered">
								...
								<c:forEach items="${certList}" var="CertVo" varStatus="listStat">
									...
									<thead style="text-align: center;">
										<tr>
											<b><td scope="row">${listStat.count}<input type="hidden"
												name="certNum" id="certNum" value="${CertVo.certNum}"></td></b>
